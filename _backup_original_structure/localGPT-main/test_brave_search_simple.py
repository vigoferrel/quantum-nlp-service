#!/usr/bin/env python3
"""
Test simple de búsqueda con Brave para el sistema cuántico
"""
...
def main():
    try:
        ...
        print("Clave API de Brave configurada")
...
if __name__ == "__main__":
    success = main()
    if success:
        print("Test de busqueda con Brave completado exitosamente")
    else:
        print("Test de busqueda con Brave fallido")
